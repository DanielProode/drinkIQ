...
export const DEFAULT_DECK_TEXT = "Embark on an Estonian Trivia Quest! This card pack awaits, offering a captivating exploration of Estonia's history, vibrant culture, sporting triumphs, diverse geography, and miscellaneous wonders. Challenge your knowledge across five categories and uncover the essence of this Baltic gem. Let the trivia adventure unveil the secrets of Estonia!";
...
export const CORRECT_ANSWER_IMAGE = require('../assets/images/correct.png');
export const WRONG_ANSWER_IMAGE = require('../assets/images/wrong.png');
export const ANSWER_PREFIXES =  ["a. ", "b. ", "c. ", "d. "];
